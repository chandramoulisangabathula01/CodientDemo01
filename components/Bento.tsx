...
import { BentoGrid, BentoGridItem } from "./ui/advcomp/bento-grid";
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="w-full bg-gray-100 h-4 rounded-full dark:bg-neutral-900 flex items-center px-2">
    ...
    >
      {arr.map((_, i) => (
        <motion.div
          ...
          className="flex flex-row rounded-full border border-neutral-100 dark:border-white/[0.2] p-2 items-center space-x-2 bg-neutral-100 dark:bg-black w-full h-6"
        >
